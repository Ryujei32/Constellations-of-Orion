...
{
	public class CosmicAstraeusRelicTile : ModTile
	{
		...
		public virtual string RelicTextureName => "ConstellationsOfOrion/Content/Tiles/Relics/CosmicAstraeusRelic";

		// ⭐ THIS IS YOUR PEDESTAL TILE
		public override string Texture => "ConstellationsOfOrion/Content/Tiles/Relics/CosmicAstraeusRelicTile";
